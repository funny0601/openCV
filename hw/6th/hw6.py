...
class Recognition:
    def ExtractNumber(self):
        ...
        cv2.rectangle(img, (box1[select][0] - 10, box1[select][1] - 10),
                      (box1[select][0] + 140, box1[select][1] + box1[select][3] + 20), (0, 255, 0), 3)
        ...
        cv2.imwrite('color_plate.jpg', resize_plate)
